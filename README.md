...
- git diff = "Эта команда сравнит последнюю закоммиченную версию файла с текущей (изменённой) версией."
- git diff --staged = "Эта команда покажет изменения в "staged"-файлах"
- echo = "Сама по себе эта команда просто выводит в консоль то, что ей передали в качестве параметра."
- echo >> "smth" = "Добавить в файл в последнюю строку что-то"
- echo > "smth" = "Перезапишет файл"
=======
...
- git restore "file" = "«Откатить» изменения, которые не попали ни в staging, ни в коммит"
- "tab" = "код блок"
>>>>>>> 1b011b6c4df99c401ff885eb8fe5a0439b5bf7b9
